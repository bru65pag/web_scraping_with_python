...
fn main() {
    ...
    let mut modulated_texture = LTexture::new(&texture_creator, Path::new("assets/fadeout.png"));
    modulated_texture.set_blend_mode(BlendMode::Blend);

    let mut background_texture = LTexture::new(&texture_creator, Path::new("assets/fadein.png"));
    ...
    while running {
        ...
        modulated_texture.render_to(&mut canvas, 0, 0);
